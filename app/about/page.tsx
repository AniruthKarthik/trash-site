...
export default function AboutPage() {
  ...
  const experiences = [
    {
      ...
      period: "2022 - Present",
      description:
        "Conducting research on neural network architectures for computer vision applications. Published two papers in top-tier conferences.",
    },
    {
      ...
      period: "2020 - 2022",
      description:
        "Assisted in research projects focused on natural language processing and sentiment analysis. Developed data collection and analysis pipelines.",
    },
    {
      ...
      period: "Summer 2019",
      description:
        "Participated in a research project on ethical AI development. Contributed to literature review and experimental design.",
    },
  ]

  const skills = [
    { category: "Languages", items: ["Python", "R", "MATLAB", "C++"] },
    { category: "Machine Learning", items: ["PyTorch", "TensorFlow", "Scikit-learn", "Keras"] },
    { category: "Data Analysis", items: ["Pandas", "NumPy", "SciPy", "SPSS"] },
    {
      category: "Research",
      items: ["Experimental Design", "Statistical Analysis", "Literature Review", "Academic Writing"],
    },
    { category: "Visualization", items: ["Matplotlib", "Seaborn", "D3.js", "Tableau"] },
    { category: "Domains", items: ["Computer Vision", "NLP", "Reinforcement Learning", "Ethics in AI"] },
  ]
  ...
  return (
    <div className="space-y-16">
      <section>
        <Terminal
          text="Initializing personal profile... Access granted. Loading research data..."
          typingSpeed={30}
        ...
        {introComplete && (
          <Terminal
            text="Hello, I'm ANI_ENG. A student researcher with a passion for AI, machine learning, and computational methods. I focus on developing novel algorithms and approaches to solve complex problems in artificial intelligence and data analysis."
            typingSpeed={20}
